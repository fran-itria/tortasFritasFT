...
const { user, product, order, options, income, expense, order_product } = sequelize.models
...
export { user as User, product as Product, order as Order, options as Options, income as Income, expense as Expense, order_product as OrderProduct }
